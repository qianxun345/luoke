...
; 3. 直接点击屏幕正中央，上下左右随机偏移5像素，然后等待 10s 代替 image2
    ...
    ; 新增点击：双人模式中间点击区域 (1390-1719, 478-519 转换自1920x1080)
    if (!isRunning) 
        break
    ToolTip, Action: Clicking Middle Right Area (72.4`% to 89.5`%`, 44.3`% to 48.1`%)
    Random, randPctX_mid, 0.7240, 0.8950
    Random, randPctY_mid, 0.4430, 0.4810
